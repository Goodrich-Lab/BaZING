...
By default, `BaHZING_Model()` and `Ridge_BaHZING_Model()` include the log of
each sample's total sequencing-library size as an offset in both the count and
zero-inflation predictors. Set `offset = FALSE` to fit the models without this
adjustment.
